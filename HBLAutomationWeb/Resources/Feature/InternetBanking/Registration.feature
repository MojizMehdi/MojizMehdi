...
Scenario Outline: As a user i want to Signup using Debit Card Web
	...
	And I wait 3000
	And verify the message "<account_tag1>" through database on "<account_query>" on Schema "<db_val>"
	And verify the message "<account_tag1>" through database on "<account_tag_query>" on Schema "<db_val>"
	And verify through database on "<password_policy_query>" on Schema "<db_val>" on "Registration_PassPolicyText"
	...
	And verify the message "<Login_id>" through database on "<login_id_query>" on Schema "<db_val>"
	And verify the result from "<created_on_query>" on Schema "<db_val>"
	And verify the result from "<updated_on_query>" on Schema "<db_val>"
	...
	And verify the message "<customer_type>" through database on "<customer_type_query>" on Schema "<db_val>"
	And verify the result from "<IVR_require_query>" on Schema "<db_val>"
	And verify the result from "<IVR_check_query>" on Schema "<db_val>"
	And verify the result from "<PARAM_CHANNEL_ID_query>" on Schema "<db_val>"
	And verify the result from "<ENABLE_PSD_require_query>" on Schema "<db_val>"
	And verify the result from "<ENABLE_PSD_check_query>" on Schema "<db_val>"
	And verify the message "<config_val1>" through database on "<config_query1>" on Schema "<db_val>"
	And verify the message "<config_val2>" through database on "<config_query2>" on Schema "<db_val>"
