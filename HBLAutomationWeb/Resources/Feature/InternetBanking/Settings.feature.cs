...
#line hidden
        ...
        public virtual void AsAUserIWantToVerifyChangeUserLoginPassword(string @case, string login_UserId_Value, string login_Password_Value, string oTP_Value, string[] exampleTags)
        {
            string[] @__tags = new string[] {
                    "Settings"};
            if ((exampleTags != null))
...
#line 24
 testRunner.And("I have given \"<textboxvalue>\" on \"<Settings_login_old_pass>\"", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line 25
 testRunner.And("I have given \"<textboxvalue>\" on \"<Settings_login_new_pass>\"", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line 26
 testRunner.And("I have given \"<textboxvalue>\" on \"<Settings_login_confirm_pass>\"", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line 27
 testRunner.When("I am performing on \"<Settings_change_login_button>\"", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line hidden
            this.ScenarioCleanup();
        }
        
        [Microsoft.VisualStudio.TestTools.UnitTesting.TestMethodAttribute()]
        [Microsoft.VisualStudio.TestTools.UnitTesting.DescriptionAttribute("As a user i want to verify change user login password: When user id and password " +
            "are valid")]
        [Microsoft.VisualStudio.TestTools.UnitTesting.TestPropertyAttribute("FeatureTitle", "Settings")]
        [Microsoft.VisualStudio.TestTools.UnitTesting.TestCategoryAttribute("Settings")]
        [Microsoft.VisualStudio.TestTools.UnitTesting.TestCategoryAttribute("source:Data/IBLogin.xlsx")]
        ...
        [Microsoft.VisualStudio.TestTools.UnitTesting.TestPropertyAttribute("Parameter:Login_Password_Value", "pakistan1")]
        [Microsoft.VisualStudio.TestTools.UnitTesting.TestPropertyAttribute("Parameter:OTP_Value", "12345")]
        public virtual void AsAUserIWantToVerifyChangeUserLoginPassword_WhenUserIdAndPasswordAreValid()
        {
#line 20
 this.AsAUserIWantToVerifyChangeUserLoginPassword("When user id and password are valid", "abby", "pakistan1", "12345", new string[] {
                        "source:Data/IBLogin.xlsx"});
#line hidden
        }
    }
