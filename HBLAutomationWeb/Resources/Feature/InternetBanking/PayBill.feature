...
@BillPayment @MultiBill_Pay @MultiBill_Home @SingleBill_Home_AddNew @SingleBill_Pay_AddNew @SingleBill_Pay_Bene
...
Scenario Outline: As a user i want to Verify Add New Bill Payment From Home Screen Icon
	...
	And verify the list using "<category_list_query>" on Schema "<db_val>"
