...
Scenario Outline: 2 As a user i want to Signup using Debit Card Mobile
	...
	Examples:
	|Case|CNIC_D|Debit_card_no|pin|Login_id|OTP_Value|password_policy_query|login_pass|tran_pass|account_tag1|account_query|account_tag_query|success_message|login_id_query|created_on_query|updated_on_query|Last_login_query|tran_pass_encrypted_value|transaction_password_query|customer_type|customer_type_query|IVR_require_query|IVR_check_query|PARAM_CHANNEL_ID_query|ENABLE_PSD_require_query|ENABLE_PSD_check_query|
