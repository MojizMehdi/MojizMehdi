...
@BillPayment @Bill_Payment_Exisitng_Bene
...
@BillPayment @Bill_Payment_Exisitng_Bene_Via_Home
...
Scenario Outline: As a user i want to Verify Multiple Bill Payment
	Given the test case title is "<Case>"
	And the user is arrive to Mobile Banking home page
	And I am clicking on "Dashboard"
	#When I save Account Balances 
	...
	Examples: 
	|Case|status_query|Consumer_Numbers|account_no|tran_pass_value|tran_type_query|tran_amount_query|from_account_query|company_name_query|consumer_no_query|bene_check_query|db_val|db_val2|Expected_Result|